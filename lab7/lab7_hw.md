...
NAs seem to be represented as "-999". 
...
NAs seem to be represented as "NA". 
...
## 1          0
```
It doesn't think there are any NAs because they are represented as "-999". 
...
This is saying we have no data (all NAs) in the egg mass column for mammals, which makes sense because most mammals do not lay eggs. 
