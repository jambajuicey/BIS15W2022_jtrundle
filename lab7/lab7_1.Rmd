...
I think we need to search for NAs in the form of -999 and replace them with "NA".  
...
```
There are 10 domestication variables in the data. 
...
```
Now we see 39 NAs because the 10 that were domestication have been changed to NAs. 
