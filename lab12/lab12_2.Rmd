...
lat <- c(34.67, 41.80)
long <- c(-124.1, -115.5)
bbox <- make_bbox(long, lat, f = 0.05) #f makes map that much bigger than the min and max latitudes and longitudes
```
...
```{r}
ggmap(map1) + 
  geom_point(data = spiders, aes(longitude, latitude), size=0.75) +
