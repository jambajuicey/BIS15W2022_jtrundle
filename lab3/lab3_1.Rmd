...
The data looks more professionally organized, but are generally in the same pattern as in a data matrix. The data frame also automatically named the columns. 
...
```{r}
hsprings <- data.frame(temp = temp, scientist = name, springs = spring)
hsprings
```
