...
ui <- fluidPage(
    ...
    sliderInput("pointsize", "Select the Point Size", min = 0.5, max = 5, value = 1.5, step = 0.1),
    plotOutput("plot", width = "500px", height = "400px") #value is where the point size starts, the step is the intervals you can change the point size to
...
ui <- dashboardPage(
  ...
  dashboardBody(
  fluidRow(
  box(title = "Plot Options", width = 4, #out of 12 (which is across the screeen)
  selectInput("x", "Select X Variable", choices = c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), 
              selected = "bill_length_mm"),
  selectInput("y", "Select Y Variable", choices = c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), 
              selected = "bill_depth_mm"),
  ...
  box(title = "Plot of Penguins Data", width = 8,
