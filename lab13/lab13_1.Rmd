...
ui <- fluidPage(
    selectInput("x", "Select X Variable", choices = c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), 
              selected = "bill_length_mm") #selectInput incorporates a drop down menu to choose variables,
                                            #selected= chooses which variables to start on
)
...
ui <- fluidPage(
    ...
    selectInput("y", "Select Y Variable", choices = c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), 
              selected = "bill_length_mm") #same thing for Y axis
)
...
ui <- fluidPage(
  ...
  plotOutput("plot", width = "500px", height = "400px") #tell shiny that we want to make a plot (with dimensions)
)
