...
homerange %>% 
  ...
  geom_boxplot(alpha=0.7, color="grey")+
  geom_violin(alpha=0.3)
```

3. What information can you gather from the violin plot that might have been missed with the box plot?

The violin plot tells us the distribution of the data, like a density plot, so we know where the most or least species are. 
